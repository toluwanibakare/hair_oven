    ...
    return (
      <footer className="bg-[#E0D5C5] text-[#2B1B12] relative border-t border-[#2B1B12]/10">
        <div className="max-w-[1600px] mx-auto px-6 lg:px-10">
          ...
          <div className="py-12 lg:py-16 border-b border-[#2B1B12]/15 flex flex-col md:flex-row items-start md:items-center justify-between gap-10">
            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="font-serif text-lg text-[#2B1B12] font-medium tracking-wide">
                  HAIR OVEN
                </div>
            ...
            <div className="space-y-2 text-xs text-[#2B1B12] font-medium">
              ...
              <div className="flex items-center gap-2">
                ...
                <a href="https://wa.me/2348051332551" target="_blank" rel="noopener noreferrer" className="hover:text-[#B8860B] transition-colors font-semibold">
                  +234 805 133 2551
                </a>
              </div>
              <div className="flex items-center gap-2">
        ...
        <div className="py-16 lg:py-20 border-b border-[#2B1B12]/15 grid lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="pt-2 space-y-2 text-xs text-[#2B1B12] font-medium">
              ...
              <div className="flex items-center gap-2">
                <span className="text-[#57534E]">WhatsApp:</span>
                <a href="https://wa.me/2348051332551" target="_blank" rel="noopener noreferrer" className="hover:text-[#B8860B] transition-colors">
                  +234 805 133 2551
                </a>
              </div>
              <div className="flex items-center gap-2">
