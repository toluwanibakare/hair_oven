    ...
    <div className="bg-[#FFFCF8] min-h-[60vh]">
      <div className="max-w-[600px] mx-auto px-6 lg:px-10 py-16">
        ...
        <div className="mt-8 bg-white border border-[rgba(28,18,14,0.08)] p-8 space-y-4">
          ...
          <input placeholder="Password" type="password" className="w-full h-11 px-4 border border-[rgba(28,18,14,0.12)] outline-none focus:border-[#2B1B12]" />
          <button className="w-full h-11 bg-[#2B1B12] text-white text-[11px] tracking-[0.16em] uppercase">Sign In - Demo</button>
