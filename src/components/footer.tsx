        ...
        <div className="py-14 lg:py-20 border-b border-white/[0.08] grid lg:grid-cols-12 gap-10">
          <div className="lg:col-span-5">
            ...
            <div className="mt-8 flex flex-wrap gap-4 items-center">
              <a href="#" className="w-11 h-11 flex items-center justify-center rounded-full border border-white/10 hover:border-[#D4AF37]/40 hover:bg-[#D4AF37]/10 text-white hover:text-[#D4AF37] transition-all" aria-label="Instagram">
              ...
              <a href="#" className="w-11 h-11 flex items-center justify-center rounded-full border border-white/10 hover:border-[#D4AF37]/40 hover:bg-[#D4AF37]/10 text-white hover:text-[#D4AF37] transition-all" aria-label="TikTok">
              ...
              <a href="https://wa.me/2340000000000" className="w-11 h-11 flex items-center justify-center rounded-full border border-white/10 hover:border-[#D4AF37]/40 hover:bg-[#D4AF37]/10 text-white hover:text-[#D4AF37] transition-all" aria-label="WhatsApp">
