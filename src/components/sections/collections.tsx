    ...
    <section ref={ref} className="bg-[#FDF8F0] py-16 lg:py-24 overflow-hidden">
      ...
      <div className="relative">
        <motion.div style={{ x }} className="flex gap-4 lg:gap-6 px-6 lg:px-10 will-change-transform">
          {collections.map((c) => (
            ...
            >
              ...
              <div className="absolute top-0 inset-x-0 p-6 flex justify-between items-start">
                ...
                <div className="text-[10px] tracking-[0.16em] uppercase bg-white text-[#1C120E] px-3 py-1.5">{c.years}</div>
              </div>
              {/* Content */}
              <div className="absolute bottom-0 inset-x-0 p-6 lg:p-8">
                ...
                <Link
                  ...
                  className="mt-6 inline-flex h-10 px-6 bg-white text-[#1C120E] text-[11px] tracking-[0.14em] uppercase items-center hover:bg-[#E8DDC9] transition-colors"
                >
                  Explore {c.subtitle} →
                </Link>
              </div>
          ...
          {/* CTA card */}
          <div className="shrink-0 w-[84vw] sm:w-[48vw] lg:w-[28vw] max-w-[420px] aspect-[3/4.2] bg-[#1C120E] text-[#E8DDC9] p-8 lg:p-10 flex flex-col justify-between border border-white/5">
            <div>
            ...
            <div className="space-y-3">
              <Link href="/shop" className="h-11 w-full bg-white text-[#1C120E] grid place-items-center text-[11px] tracking-[0.16em] uppercase">Take the Quiz</Link>
              <a href="https://wa.me/2340000000000" className="h-11 w-full border border-white/20 grid place-items-center text-[11px] tracking-[0.16em] uppercase text-white hover:bg-white hover:text-[#1C120E] transition-colors">Consult via WhatsApp</a>
            </div>
          </div>
        </motion.div>
      </div>
