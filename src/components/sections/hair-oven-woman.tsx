          ...
          <div className="lg:col-span-7">
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">
              {personas.map((p, i) => (
                ...
                >
                  <WatermarkImage src={p.img} alt={p.label} containerClassName="absolute inset-0 w-full h-full" imageClassName="w-full h-full object-cover group-hover:scale-[1.04] transition-transform duration-700" watermarkSize="sm" showWatermark={false} />
