        ...
        <div className="mt-10 grid lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-12 mt-4 grid md:grid-cols-3 gap-6">
            <div className="md:col-span-2 relative aspect-[16/9] md:aspect-[2.2] overflow-hidden bg-[#F5EFE6] group">
              <WatermarkImage src="/products/editorial-blowdry.jpg" alt="Editorial hair styling" containerClassName="absolute inset-0 w-full h-full" imageClassName="w-full h-full object-cover object-center group-hover:scale-[1.02] transition-transform duration-700" watermarkSize="lg" />
