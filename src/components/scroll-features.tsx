...
export function ScrollFeatures() {
  ...
  return (
    <>
      ...
      <button 
        onClick={scrollTop}
        className={`fixed bottom-24 right-6 sm:bottom-24 sm:right-8 w-11 h-11 sm:w-12 sm:h-12 bg-[#D4AF37] text-[#2B1B12] rounded-full flex items-center justify-center hover:bg-[#2B1B12] hover:text-[#D4AF37] hover:border hover:border-[#D4AF37] transition-all duration-300 shadow-2xl z-[70] ${showScroll ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8 pointer-events-none'}`}
