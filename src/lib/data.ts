...
export const products: Product[] = [
  ...
  },
  {
    ...
    category: "Wigs",
    price: 1595000,
    image: "/products/another_one_essential.jpeg",
    images: ["/products/another_one_essential.jpeg", "/products/essential.jpeg"],
    lengths: ['24"', '26"', '28"', '30"'],
    lengthPrices: {
      '24"': 1595000,
      '26"': 1650000,
    ...
    colors: ["Honey Blonde with Dark Shadow Root"],
    density: "Full Precision Volume (385g)",
    texture: "Sculpted Waves",
    capSize: ["S", "M", "L", "XL"],
    description:
      "A masterpiece of quiet luxury, The Essential presents voluminous sculpted waves with a dark shadow root, seamless blending, and immaculate bounce.",
    longDescription:
      "A masterpiece of quiet luxury, The Essential presents voluminous sculpted waves with a dark shadow root, seamless blending, and immaculate bounce. Cut from premium human hair and paired with a 6x6 HD lace closure, this unit delivers natural hairline blending and high-end movement.",
    details: [
      "Style: Voluminous Sculpted Waves",
    ...
    modelSpecs: {
      ...
      texture: "100% Premium Human Hair (Sculpted Waves)",
      length: '24" - 30"',
      density: "Full Precision Volume (385g)",
      color: "Honey Blonde with Dark Shadow Root",
  ...
  },
  {
    ...
    images: ["/products/another_essential.jpeg"],
    lengths: ['6"', '8"', '10"'],
    lengthPrices: {
      '6"': 350000,
      '8"': 380000,
    ...
    colors: ["Honey Blonde Precision Finish"],
    density: "Full Precision Density",
    texture: "Sleek Precision Cut",
    capSize: ["S", "M", "L", "XL"],
    description:
      "Designed for the woman who values quiet distinction, this timeless silhouette transitions seamlessly from day to evening, offering exceptional versatility without compromising its refined character.",
    longDescription:
      "Designed for the woman who values quiet distinction, this timeless silhouette transitions seamlessly from day to evening, offering exceptional versatility without compromising its refined character.",
    details: [
      "Premium human hair",
      ...
      "Designed for effortless styling and longevity",
    ],
    modelSpecs: {
      closureType: "Thin HD Lace Closure",
      texture: "100% Premium Human Hair (Sleek Precision Cut)",
      length: '6" - 10"',
      density: "Full Precision Density",
      color: "Honey Blonde Precision Finish",
...
export const testimonials = [
  ...
  },
  {
    name: "Zainab A.",
    location: "London, UK",
    text: "My hairstylist asked where I got this unit because the Oven Veil lace literally melted into my scalp without heavy bleaching. Truly elite master craftsmanship.",
  ...
  },
  {
    ...
    text: "I wore The Adewunmi unit for an event and everyone kept asking if it was my natural hair silk-pressed. Incredible density, soft finish, and zero shedding.",
    product: "The Adewunmi",
    rating: 5,
  },
];
